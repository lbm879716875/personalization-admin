...
@Repository
public interface TmplCmpntLeadEffDao extends CssJpaRepository<PersTmplCmpntLeadEffDte,Integer>{
	...
	public List<PersTmplCmpntLeadEffDte> findByTmplCmpntIdAndRegnRefCdeAndSuplrIdAndSeqNbr(String tmplCmpntId,String regnRefCde,String suplrId,Integer seqNbr);
}
